...
def GetDaySpectralData(dateCur, datetimeBegin, datetimeEnd,
    ...
    #     stSQL = "SELECT CLng([tmpSpectralData].[ID]) AS SpectID, " & _
         ...
         stSQL = "INSERT INTO tmpSpectralDataToUpdate ( SpectID, TimeDifference, ValForUpdate ) " & _
              ...
              "Abs([tmpSpectralData]![Timestamp]-" & _
              "[tmpSpectralDataForUpdate]![NearTimestamp]) AS TimeDifference, " & _
              "[tmpSpectralDataForUpdate].ValForUpdate " & _
              "FROM tmpSpectralDataForUpdate, tmpSpectralData " & _
              "WHERE (((Abs([tmpSpectralData]![Timestamp]-" & _
              "[tmpSpectralDataForUpdate]![NearTimestamp]))<=" & dblTimeSpacing & "));"
    ...
    #     Debug.Print stSQL
         ...
         stSQL = "DELETE * FROM tmpSpectralDataToUpdate " & _
              ...
              "WHERE ((([tmpSpectralDataToUpdate].[SpectID]=[tmpSpectralDataToUpdate_1].[SpectID])=True) " & _
